"""
Slunder Studio - Redacted diagnostics and health report export.
"""
...
def _model_info(manager: ModelManager, replacements: Iterable[tuple[str, str]]) -> list[dict[str, Any]]:
    ...
    for model_id, info in sorted(manager.registry.items()):
        ...
        models.append({
            ...
            "variant_family": info.variant_family,
            "quantization": info.quantization,
            "quantization_bits": info.quantization_bits,
            "quality_label": info.quality_label,
            "benchmark_quality_score": info.benchmark_quality_score,
            "benchmark_latency_tokens_per_second": info.benchmark_latency_tokens_per_second,
            "benchmark_hardware": info.benchmark_hardware,
            "benchmark_sample_count": info.benchmark_sample_count,
            "source": info.source,
